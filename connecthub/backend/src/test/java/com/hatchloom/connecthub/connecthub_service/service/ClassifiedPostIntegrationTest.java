...
@Tag("integration")
class ClassifiedPostIntegrationTest {
        @Autowired
        ...
        void setup() {
                ...
                testUser = new BaseUser(UUID.fromString("00000000-0000-0000-0000-000000000001"), "testuser",
                                "test@gmail.com");
                testProject = new BaseProject(UUID.fromString("00000000-0000-0000-0000-000000000002"), "Test Project",
                                "A project for testing", testUser, List.of());
                testUser2 = new BaseUser(UUID.fromString("00000000-0000-0000-0000-000000000003"), "testuser2",
                                "test2@gmail.com");
        ...
        void testCreateClassifiedPost() throws Exception {
                ClassifiedPostCreationRequest dto = new ClassifiedPostCreationRequest(
                                new BasePostRequest("Classified test post",
                                                "This is a classified test"),
                                testProject.id, null, "open");
        ...
        void testCreateClassifiedPostInvalidStatus() throws Exception {
                ClassifiedPostCreationRequest dto = new ClassifiedPostCreationRequest(
                                new BasePostRequest("Classified test post",
                                                "This is a classified test"),
                                testProject.id, null, "invalid_status");
        ...
        void testCreateClassifiedPostNullFields() throws Exception {
                ClassifiedPostCreationRequest dto = new ClassifiedPostCreationRequest(new BasePostRequest("", ""), null,
                                null, "open");
        ...
        void testCreateClassifiedPostLongTitle() throws Exception {
                ClassifiedPostCreationRequest dto = new ClassifiedPostCreationRequest(
                                new BasePostRequest("A".repeat(300),
                                                "This is a classified test"),
                                testProject.id, null, "open");
        ...
        void testGetClassifiedPostsWithPagination() throws Exception {
                ...
                for (int i = 0; i < upperLimit; i++) {
                        ClassifiedPostCreationRequest dto = new ClassifiedPostCreationRequest(
                                        new BasePostRequest("Classified test post" + i,
                                                        "This is a classified test"),
                                        testProject.id, null, "open");
        ...
        void testGetClassifiedPostsMultiplePages() throws Exception {
                ...
                while (true) {
                        ...
                        CursorResponse<ClassifiedPost> cursorResponse = objectMapper.readValue(response,
                                        objectMapper.getTypeFactory().constructParametricType(CursorResponse.class,
                                                        ClassifiedPost.class));
