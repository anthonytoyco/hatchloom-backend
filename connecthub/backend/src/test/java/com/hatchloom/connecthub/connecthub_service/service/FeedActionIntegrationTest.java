...
@Tag("integration")
public class FeedActionIntegrationTest {
        @Autowired
        ...
        void setup() throws Exception {
                ...
                testUser = new BaseUser(UUID.fromString("00000000-0000-0000-0000-000000000001"), "testuser",
                                "test@gmail.com");
                anotherUser = new BaseUser(UUID.fromString("00000000-0000-0000-0000-000000000002"), "anotheruser",
        ...
        void testLikePost() throws Exception {
                ...
                FeedAction like = feedActionRepository
                                .findByPostIdAndUserIdAndActionType(post.getId(), anotherUser.id, "like").orElse(null);
        ...
        void testAddComment() throws Exception {
                ...
                FeedAction comment = feedActionRepository
                                .findByPostIdAndUserIdAndActionType(post.getId(), anotherUser.id, "comment")
                                .orElse(null);
        ...
        void testDeleteComment() throws Exception {
                ...
                FeedAction deletedComment = feedActionRepository
                                .findByIdAndUserIdAndActionType(comment.getId(), anotherUser.id, "comment")
                                .orElse(null);
        ...
        void testDeleteUnauthorizedComment() throws Exception {
                ...
                FeedAction existingComment = feedActionRepository
                                .findByIdAndUserIdAndActionType(comment.getId(), anotherUser.id, "comment")
                                .orElse(null);
        ...
        void testLikeComment() throws Exception {
                ...
                FeedAction like = feedActionRepository
                                .findByParentActionIdAndUserIdAndActionType(comment.getId(), testUser.id, "like")
                                .orElse(null);
                Assertions.assertNotNull(like);
        }
        ...
        void testUnlikeComment() throws Exception {
                ...
                mockMvc.perform(delete("/api/feed/actions/comment/{commentId}/like", comment.getId())
                                ...
                                .with(csrf())
                                .header("Authorization", "Bearer " + testUserToken)).andExpect(status().isOk());
                FeedAction like = feedActionRepository
                                .findByParentActionIdAndUserIdAndActionType(comment.getId(), testUser.id, "like")
                                .orElse(null);
                Assertions.assertNull(like);
        ...
        void testUnlikeCommentNotLiked() throws Exception {
                ...
                mockMvc.perform(delete("/api/feed/actions/comment/{commentId}/like", comment.getId())
                                .contentType(MediaType.APPLICATION_JSON)
                                .with(csrf())
                                .header("Authorization", "Bearer " + testUserToken)).andExpect(status().isBadRequest());
        }
