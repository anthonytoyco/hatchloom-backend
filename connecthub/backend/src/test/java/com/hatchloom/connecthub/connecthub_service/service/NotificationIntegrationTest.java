...
public class NotificationIntegrationTest {
        ...
        void setup() {
                ...
                recipient = new BaseUser(UUID.fromString("00000000-0000-0000-0000-000000000002"), "Recipient",
                                "recipient@gmail.com");
                thirdUser = new BaseUser(UUID.fromString("00000000-0000-0000-0000-000000000003"), "Third User",
                                "thirdUser@gmail.com");
                project = new BaseProject(UUID.fromString("00000000-0000-0000-0000-000000000011"), "Test Project",
                                "This is a test project", sender, null);
        ...
        void testClassifiedPostNotification() throws Exception {
                ...
                ClassifiedPostCreationRequest request = new ClassifiedPostCreationRequest(
                                new BasePostRequest("Test classified", "Classified post"), project.id, null, "open");
                ...
                Assertions.assertEquals(1,
                                notificationRepository.findByRecipientUserIdAndTypeOrderByCreatedAtDesc(recipient.id,
                                                NotificationType.CLASSIFIED_CREATED).size());
                Assertions.assertEquals(1,
                                notificationRepository.findByRecipientUserIdAndTypeOrderByCreatedAtDesc(thirdUser.id,
                                                NotificationType.CLASSIFIED_CREATED).size());
                ...
                List<NotificationResponse> notifications1List = objectMapper.readValue(notifications1,
                ...
                List<NotificationResponse> notifications2List = objectMapper.readValue(notifications2,
                                new TypeReference<List<NotificationResponse>>() {
                                });
        ...
        void testMarkNotificationAsRead() throws Exception {
                ...
                List<NotificationResponse> notifications3List = objectMapper.readValue(notifications3,
                                new TypeReference<List<NotificationResponse>>() {
                                });
        ...
        void testMessageNotification() throws Exception {
                ...
                List<Notification> notifications = notificationRepository
                                .findByRecipientUserIdAndTypeOrderByCreatedAtDesc(recipient.id,
                ...
                List<NotificationResponse> notificationsList = objectMapper.readValue(notificationsStr,
                                new TypeReference<List<NotificationResponse>>() {
                                });
        ...
        void testMarkNotificationAsReadUnauthorized() throws Exception {
                ...
                List<Notification> notifications = notificationRepository
                                .findByRecipientUserIdAndTypeOrderByCreatedAtDesc(recipient.id,
                                                NotificationType.CLASSIFIED_CREATED);
